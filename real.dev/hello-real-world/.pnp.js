  ...
  return hydrateRuntimeState(
    {
      ...
      ignorePatternData:
        "(^(?:\\.vscode\\/pnpify(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)|$))$)",
      fallbackExclusionList: [["hello-real-world", ["workspace:."]]],
      fallbackPool: [
        ["dotenv", "npm:8.2.0"],
        ["express", "npm:4.17.1"],
      ],
          ...
          [
            [
              "npm:1.1.1",
              {
                ...
                packageDependencies: [["array-flatten", "npm:1.1.1"]],
                linkType: "HARD",
              },
            ],
          ],
          ...
          [
            [
              "npm:1.0.4",
              {
                ...
                packageDependencies: [["content-type", "npm:1.0.4"]],
                linkType: "HARD",
              },
            ],
          ],
          ...
          [
            [
              "npm:1.0.6",
              {
                ...
                packageDependencies: [["cookie-signature", "npm:1.0.6"]],
                linkType: "HARD",
              },
            ],
          ],
        ...
        [
          ...
          [
            [
              ...
              {
                packageLocation:
                  "./.yarn/cache/dotenv-npm-8.2.0-6b21df4d37-2.zip/node_modules/dotenv/",
          ...
          [
            [
              "npm:1.1.1",
              {
                ...
                packageDependencies: [["ee-first", "npm:1.1.1"]],
                linkType: "HARD",
              },
            ],
          ],
          ...
          [
            [
              "npm:1.0.2",
              {
                ...
                packageDependencies: [["encodeurl", "npm:1.0.2"]],
                linkType: "HARD",
              },
            ],
          ],
          ...
          [
            [
              "npm:1.0.3",
              {
                ...
                packageDependencies: [["escape-html", "npm:1.0.3"]],
                linkType: "HARD",
              },
            ],
          ],
          ...
          [
            [
              "npm:0.1.2",
              {
                ...
                packageDependencies: [["forwarded", "npm:0.1.2"]],
                linkType: "HARD",
              },
            ],
          ],
          ...
          [
            [
              "npm:1.9.1",
              {
                ...
                packageDependencies: [["ipaddr.js", "npm:1.9.1"]],
                linkType: "HARD",
              },
            ],
          ],
          ...
          [
            [
              "npm:0.3.0",
              {
                ...
                packageDependencies: [["media-typer", "npm:0.3.0"]],
                linkType: "HARD",
              },
            ],
          ],
          ...
          [
            [
              "npm:1.0.1",
              {
                ...
                packageDependencies: [["merge-descriptors", "npm:1.0.1"]],
                linkType: "HARD",
              },
            ],
          ],
          ...
          [
            [
              "npm:0.6.2",
              {
                ...
                packageDependencies: [["negotiator", "npm:0.6.2"]],
                linkType: "HARD",
              },
            ],
          ],
          ...
          [
            [
              "npm:1.3.3",
              {
                ...
                packageDependencies: [["parseurl", "npm:1.3.3"]],
                linkType: "HARD",
              },
            ],
          ],
          ...
          [
            [
              "npm:0.1.7",
              {
                ...
                packageDependencies: [["path-to-regexp", "npm:0.1.7"]],
                linkType: "HARD",
              },
            ],
          ],
          ...
          [
            [
              "npm:1.2.1",
              {
                ...
                packageDependencies: [["range-parser", "npm:1.2.1"]],
                linkType: "HARD",
              },
            ],
          ],
          ...
          [
            [
              "npm:1.5.0",
              {
                ...
                packageDependencies: [["statuses", "npm:1.5.0"]],
                linkType: "HARD",
              },
            ],
          ],
          ...
          [
            [
              "npm:1.0.1",
              {
                ...
                packageDependencies: [["utils-merge", "npm:1.0.1"]],
                linkType: "HARD",
              },
            ],
          ],
    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        class NodeFS extends FakeFS_1.BasePortableFakeFS {
          ...
          async appendFilePromise(p, content, opts) {
            return await new Promise((resolve, reject) => {
              const fsNativePath =
                typeof p === `string` ? path_1.npath.fromPortablePath(p) : p;
          ...
          readlinkSync(p) {
            return path_1.npath.toPortablePath(
              this.realFs.readlinkSync(path_1.npath.fromPortablePath(p))
            );
          }
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        class ZipFS extends FakeFS_1.BasePortableFakeFS {
          ...
          saveAndClose() {
            ...
            if (rc === -1)
              throw new Error(
                this.libzip.error.strerror(this.libzip.getError(this.zip))
          ...
          getFileSource(index) {
            ...
            try {
              ...
              try {
                ...
                if (rc === -1)
                  throw new Error(
                    this.libzip.error.strerror(this.libzip.file.getError(file))
                  );
          ...
          readdirSync(p, { withFileTypes } = {}) {
            ...
            return entries.map((name) => {
              return Object.assign(
                this.statImpl(`lstat`, path_1.ppath.join(p, name)),
                {
                  name,
                }
              );
        ...
        class ZipOpenFS extends FakeFS_1.BasePortableFakeFS {
          ...
          findZip(p) {
            ...
            for (let t = 2; t <= parts.length; ++t) {
              ...
              const isZip =
                stat.isFile() &&
                this.pathUtils.extname(realArchivePath) === `.zip`;
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function getLibzipSync() {
          if (mod === null)
            mod = makeInterface_1.makeInterface(__webpack_require__(26));
          return mod;
        }
        ...
        function makeApi(runtimeState, opts) {
                ...
                try {
                  pkgJson = JSON.parse(
                    opts.fakeFs.readFileSync(
                      fslib_2.ppath.join(
                        unqualifiedPath,
                        fslib_2.toFilename(`package.json`)
                      ),
                      `utf8`
                    )
                  );
          ...
          function findPackageLocator(location) {
            let relativeLocation = normalizePath(
              fslib_2.ppath.relative(runtimeState.basePath, location)
            );
          ...
          function resolveToUnqualified(
            ...
            if (request === `pnpapi`)
              return fslib_1.npath.toPortablePath(opts.pnpapiResolution); // Bailout if the request is a native module
              ...
              if (typeof dependencyReference === `undefined`) {
                if (issuerLocator.name !== null) {
                  ...
                  if (canUseFallbacks) {
                    ...
                    if (
                      typeof dependencyReference === `undefined` &&
            ...
            resolveToUnqualified: maybeLog(
              ...
              (request, issuer, opts) => {
                const portableIssuer =
                  issuer !== null ? fslib_1.npath.toPortablePath(issuer) : null;
            ...
            resolveUnqualified: maybeLog(
              ...
              (unqualifiedPath, opts) => {
                return fslib_1.npath.fromPortablePath(
                  resolveUnqualified(
                    fslib_1.npath.toPortablePath(unqualifiedPath),
                    opts
                  )
                );
              }
